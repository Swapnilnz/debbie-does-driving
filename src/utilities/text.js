...
export const carTrainingRestricted = 'You will already be experienced in the basic skills of moving your vehicle forward, back, left and right. Ideally you have been in traffic for 3 months+ and can score your confidence at 5 or 6/10.\n' +
    '\n' +
    'Be prepared to learn and open to taking advice from Debbie, your professional driving coach. Your driving skills will be assessed in both 50 km/hr areas and higher speed limits, with coaching provided to sharpen up, not only to help you succeed on test day, but to help keep you safe (primary goal) from mistakes by other road users.\n' +
    '\n' +
    'But driving skills are only part of keeping safe on our roads. The bigger picture is attitide. How we feel is how we drive ... right? So how we drive is a relection of how we feel. Think about the attitude YOU bring to the wheel. \n' +
    '\n' +
    'You will also learn more about the capability of the vehicle you drive AND your own capability, alongside vehicle dynamics management techniques. \n' +
    '\n' +
    'Do you know: what are your tyre pressures? have you changed a flat tyre? ABS? FWD/RWD? how do changing conditions affect me? tyre footprint? relationship between speed & stopping distances?"\n' +
    '\n' +
    'You will need your NZ photo drivers licence and roadworthy vehicle ready to go with “L” plates up, outside VTNZ, Mersey Street Invercargill. Please park roadside only (not in carpark). If you are not ready to go and/or your drive cannot be done (no drivers licence / L plates, non-roadworthy vehicle, another reason) the full fee still applies. '

export const carTrainingRestrictedSmall = 'Prepare for your restricted car license.'

export const carTrainingFull = 'For clients who have NOT done a Defensive Driving Course. \n' +
    '\n' +
    'You will have both town and country driving experience, in different conditions. \n' +
    '\n' +
    'Be prepared to learn and open to taking advice from Debbie, your professional driving coach. Although the 1F car test is conducted in a 50 km/hr area only, your driving skills will be assessed by Debbie in both 50 km/hr areas and higher speed limits. Coaching will be provided to sharpen up, not only to help you succeed on test day, but to help keep you safe (primary goal) from mistakes by other road users. \n' +
    '\n' +
    'But driving skills are only part of keeping safe on our roads. The bigger picture is attitide. How we feel is how we drive ... right? So how we drive is a relection of how we feel. Think about the attitude YOU bring to the wheel. \n' +
    '\n' +
    'You will also learn more about the capability of the vehicle you drive AND your own capability, alongside vehicle dynamics management techniques. \n' +
